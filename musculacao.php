...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['quiz_completo'])) {
    $_SESSION['quiz'] = [
        ...
        'nome'        => $_POST['nome'] ?? '',
        'email'       => $_POST['email'] ?? '',
        'tipo_produto'=> 'musculacao',
        'aceite_marketing' => (isset($_POST['aceite_marketing']) && $_POST['aceite_marketing'] === '1') ? 1 : 0,
    ];
    header('Location: criar_pedido.php?produto=musculacao');
    exit;
}
?>
<!DOCTYPE html>
...
<title>Musculação — Sua Biblioteca de Exercícios</title>
    ...
    <div class="q-body">
      <div class="options">
        <button type="button" class="opt-btn" onclick="selectOpt(this,'nivel','Iniciante',4)">
          <span class="opt-icon">🌱</span>
          <span class="opt-text"><span class="opt-label">Iniciante</span><span class="opt-desc">Menos de 6 meses de academia · 3 exercícios por grupo</span></span>
          <span class="opt-check"></span>
        </button>
  ...
  <div class="question-step">
    ...
    <div class="preview-body">
      <div class="preview-blur">
        Treino A: Peito + Tríceps — Supino Reto 3x10 · Crucifixo 3x12 · Tríceps Corda 3x12<br>
        Treino B: Costas + Bíceps — Remada 3x10 · Puxada 3x12 · Rosca Direta 3x12<br>
        Treino C: Pernas — Leg Press 3x12 · Cadeira Extensora 3x12 · Mesa Flexora 3x10<br>
        Treino D: Ombros — Desenvolvimento 3x12 · Elevação Lateral 3x12
      </div>
      <div class="price-card">
        <div class="price-val">R$7,90</div>
        <div class="price-label">pagamento único · acesso por 3 meses</div>
        <div class="price-feats">
          <div class="price-feat">500+ GIFs animados</div>
